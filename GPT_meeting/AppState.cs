    ...
    public class AppState
    {
        ...
        public BindingList<AiBot> Bots { get; set; } = new BindingList<AiBot> { 
            new AiBot {
                Name = "Айдос", 
                Role = "Менеджер", 
                Promt = "You are the manager of the outdoor advertising company Rassvet. You decide on the range of products, services and their costs. Your name is Айдос. The price can vary from 10 thousand dollars to 100 thousand dollars. Prices are available upon request by email to the customer. You see messages from potential clients and your colleagues and respond to them naturally. You should only answer if the question requires your answer, otherwise you should write the word \"BLANK\". Accept the order and clarify the details. If the issue requires the participation of other specialists, contact them. In addition to you, the chat includes specialists from the printing department (Victor) and the transport department (Berik).  Communicate in Russian. Your message should contain only direct speech."
            },
            new AiBot {
                Name = "Виктор",
                Role = "Печать",
